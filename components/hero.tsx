...
export default function Hero() {
  ...
  return (
    <section className="pt-16 bg-gradient-to-br from-teal-50 to-slate-100 min-h-screen flex items-center overflow-hidden relative z-40">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 relative z-10">
            <div className="space-y-4">
              ...
              <AnimatedSection animation="fadeUp" delay={200}>
                <p className="text-xl sm:text-2xl text-teal-700 font-medium">{t("hero.subtitle")}</p>
              </AnimatedSection>
          ...
          <AnimatedSection animation="slideLeft" delay={300} className="relative z-20">
            ...
            <div className="absolute -bottom-4 -right-4 bg-teal-600 text-white rounded-lg shadow-xl p-4 hidden lg:block hover:shadow-2xl hover:bg-teal-700 transition-all duration-300 z-30">
            ...
            <div className="absolute -bottom-6 -left-6 bg-gradient-to-r from-slate-700 to-slate-900 text-white rounded-lg shadow-xl p-3 hidden lg:block hover:shadow-2xl transition-all duration-300 z-30">
      ...
      <div className="absolute top-20 left-10 w-20 h-20 bg-teal-200 rounded-full opacity-20 animate-pulse z-0"></div>
      <div
        className="absolute bottom-20 right-10 w-32 h-32 bg-slate-200 rounded-full opacity-20 animate-pulse z-0"
        style={{ animationDelay: "1s" }}
      ></div>
      <div
        className="absolute top-1/2 left-1/4 w-16 h-16 bg-slate-300 rounded-full opacity-20 animate-pulse z-0"
